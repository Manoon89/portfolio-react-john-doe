                ...
                <div className="row d-flex justify-content-center mb-4">
                    ...
                    <Services 
                        ...
                        img=
                            <svg 
                                ...
                                width="32" height="32" fill="currentColor" className="bi bi-brush text-primary m-auto mt-4" 
                                viewBox="0 0 16 16">
                    ...
                    <Services 
                        ...
                        img=
                            <svg 
                                xmlns="http://www.w3.org/2000/svg" 
                                width="32" height="32" fill="currentColor" className="bi bi-code-slash text-primary m-auto mt-4" 
                                viewBox="0 0 16 16">
                    ...
                    <Services 
                        ...
                        img=
                            <svg 
                                xmlns="http://www.w3.org/2000/svg" 
                                width="32" height="32" fill="currentColor" className="bi bi-search text-primary m-auto mt-4" 
                                viewBox="0 0 16 16">
