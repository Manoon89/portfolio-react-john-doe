    ...
    return (
        <div>
            <Header title="Bonjour, je suis John Doe" subtitle="Développeur web full stack"
             modal={<Modale />} bg="index-header-titles" classH1="title-home text-center pt-4"/>
                ...
                <div className="row">
                    ...
                    <section className="col-md-6 m-0 p-2">
                        <h3 className="section-title-home border-bottom border-primary pb-4 mb-4 border-4">Mes compétences</h3>
                            ...
                            <h4 className="skills mt-2">JAVASCRIPT 70%</h4>
                            ...
                            <h4 className="skills mt-2">PHP 60%</h4>
                            ...
                            <h4 className="skills mt-2">REACT 50%</h4>
